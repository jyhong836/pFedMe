...
import random
import os
from FLAlgorithms.servers.serveravg import FedAvg, FedLocal
from FLAlgorithms.servers.serverpFedMe import pFedMe, pFedMeLocal
...
def main(dataset, algorithm, model, batch_size, learning_rate, beta, lamda, num_glob_iters,
    ...
    for i in range(times):
        ...
        elif algorithm=="FedLocal":
            server = FedLocal(dataset, algorithm, model, batch_size, learning_rate, beta, lamda, num_glob_iters, local_epochs, optimizer, numusers, i)

        elif algorithm=="pFedMeLocal":
            server = pFedMeLocal(dataset, algorithm, model, batch_size, learning_rate, beta, lamda, num_glob_iters, local_epochs, optimizer, numusers, K, personal_learning_rate, i)

        else:
            raise ValueError(f"Wrong alg: {algorithm}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="pFedMe",choices=["pFedMe", "PerAvg", "FedAvg", "FedLocal", "pFedMeLocal"])
